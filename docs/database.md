...
erDiagram
    ...
    POST {
        ...
        string coverImageKey "R2/S3 object key, nullable"
        string thumbnailKey "R2/S3 object key, nullable"
...
| `coverImageKey` | `String?` | `TEXT` | **Yes** | `null` | — | Cloudflare R2 / S3 object key for the post cover image |
| `thumbnailKey` | `String?` | `TEXT` | **Yes** | `null` | — | Cloudflare R2 / S3 object key for the post thumbnail image |
